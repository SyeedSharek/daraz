                ...
                <tr>
                    ...
                    <td class="row">
                        <div class="span3"></div>
                         ...
                         <a href="{{ url('/bra_status').$brand->id }}" class="btn btn-success" >
                            <i class="halflings-icon white thumbs-down"></i> 
                            
                         </a>
                        
                         @else
                         <a href="{{ url('/bra_status').$brand->id }}" class="btn btn-danger" >
                        ...
                        <div class="span2">
                         ...
                         <a href="{{url('/brands/'.$brand->id.'/edit') }}" class="btn btn-info" >
