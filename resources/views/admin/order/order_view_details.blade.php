        ...
        <div class="box span12" style="margin-left: auto;">
            ...
            <div class="box-content">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($orders_by_id as $order_product )
                            
                        
                        <tr>
                            <td>{{ $order_product->order->id }}</td>
                            <td class="center">{{ $order_product->product->name }}</td>
                            <td class="center">&#2547; {{ $order_product->product->price }}</td>
                            <td class="center">{{ $order_product->product_sales_quantity }}</td>
                            <td class="center"> &#2547; {{ $order_product->product->price * $order_product->product_sales_quantity }}</td>
                        </tr>
                        @endforeach
