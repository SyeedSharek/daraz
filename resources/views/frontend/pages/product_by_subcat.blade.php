                ...
                <div class="aside">
                    ...
                    <div class="checkbox-filter">
                        @foreach ($categories as $category )
                                @php
                                    $CatProductCount = App\Models\Product::subCatProductCount($category->id);
                                @endphp
                        ...
                        <div class="input-checkbox">
                            ...
                            <label for="category-4">
                                <span></span>
                                <li>
                                    <a href="{{ url('/cat_by_product/'.$category->id) }}">
                                         {{ $category->name }}
                                    </a>
                                </li>
                    ...
                    <div class="col-md-4 col-xs-6">
                        ...
                        <div class="product">
                            <div class="product-img"><a href="{{ url('/view_product/'.$product->id) }}" >
                                <img src="{{ asset('/product_image/'.$images) }}" style="height: 180px; width: 250px;" alt="">
